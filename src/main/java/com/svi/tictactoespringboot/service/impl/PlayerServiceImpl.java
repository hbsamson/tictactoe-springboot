...
public class PlayerServiceImpl implements PlayerService {
 ...
 public PlayerResponse create(CreatePlayerRequest r) { return playerMapper.toResponse(players.save(new Player(UUID.randomUUID(), r.name().trim(), normalize(r.avatarUrl()), Instant.now()))); }
